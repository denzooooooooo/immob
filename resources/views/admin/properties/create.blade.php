...
@section('title', 'Créer une nouvelle propriété')
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center mb-3">
                    <span class="badge badge-create">Création en cours</span>
                </div>
                <h1 class="property-title">Créer une nouvelle propriété</h1>
                <p class="property-subtitle">Ajoutez une nouvelle propriété à votre plateforme immobilière</p>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="form-group-modern">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" required
                                class="form-control-modern" placeholder="Ex: Villa moderne avec piscine">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                ...
                                <select name="currency" id="currency" class="form-control-modern currency-select">
                                    <option value="XAF" {{ old('currency') == 'XAF' ? 'selected' : '' }}>XAF</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-modern">
                            ...
                            <input type="number" name="surface_area" id="surface_area" value="{{ old('surface_area') }}" min="0" step="0.01" required
                                class="form-control-modern" placeholder="120.5">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group-modern">
                            ...
                            <textarea name="description" id="description" rows="6" required
                                class="form-control-modern textarea-modern" placeholder="Décrivez la propriété en détail...">{{ old('description') }}</textarea>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="form-group-modern">
                            ...
                            <input type="number" name="bedrooms" id="bedrooms" value="{{ old('bedrooms') }}" min="0"
                                class="form-control-modern" placeholder="3">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group-modern">
                            ...
                            <input type="number" name="bathrooms" id="bathrooms" value="{{ old('bathrooms') }}" min="0"
                                class="form-control-modern" placeholder="2">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group-modern">
                            ...
                            <input type="number" name="year_built" id="year_built" value="{{ old('year_built') }}" min="1900" max="2025"
                                class="form-control-modern" placeholder="2020">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-modern">
                            ...
                            <input type="number" name="parking_spaces" id="parking_spaces" value="{{ old('parking_spaces') }}" min="0"
                                class="form-control-modern" placeholder="1">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-modern">
                            ...
                            <div class="amenities-grid-create">
                                ...
                                <label class="amenity-checkbox">
                                    <input type="checkbox" name="air_conditioning" value="1" {{ old('air_conditioning') ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                    <i class="fas fa-snowflake"></i> Climatisation
                                </label>
                                <label class="amenity-checkbox">
                                    <input type="checkbox" name="swimming_pool" value="1" {{ old('swimming_pool') ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                    <i class="fas fa-swimming-pool"></i> Piscine
                                </label>
                                <label class="amenity-checkbox">
                                    <input type="checkbox" name="security_system" value="1" {{ old('security_system') ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                ...
                                <label class="amenity-checkbox">
                                    <input type="checkbox" name="garden" value="1" {{ old('garden') ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                ...
                                <label class="amenity-checkbox">
                                    <input type="checkbox" name="elevator" value="1" {{ old('elevator') ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                                ...
                                <label class="amenity-checkbox">
                                    <input type="checkbox" name="terrace" value="1" {{ old('terrace') ? 'checked' : '' }}>
                                    <span class="checkmark"></span>
                ...
                <div class="row g-4">
                        ...
                        <div class="form-group-modern">
                            ...
                            <select name="city" id="city" required class="form-control-modern">
                                ...
                                @foreach ($cities as $city)
                                    <option value="{{ $city->slug }}" {{ old('city') == $city->slug ? 'selected' : '' }}>
                                        {{ $city->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-modern">
                            ...
                            <select name="neighborhood" id="neighborhood" required class="form-control-modern"
                                data-current-neighborhood="{{ old('neighborhood') }}">
                ...
                <div class="publication-options">
                    <div class="option-item">
                        <div class="option-toggle">
                            <input type="checkbox" name="featured" value="1" id="featured" {{ old('featured') ? 'checked' : '' }}>
        ...
        <div class="action-footer">
            <div class="action-buttons">
                ...
                <button type="submit" class="btn btn-primary-modern">
                    <i class="fas fa-plus"></i> Créer la propriété
                </button>
            </div>
        </div>
    </form>
...
<style>
/* Styles modernes pour la page de création avec thème violet-rouge */
.property-header {
