        ...
        <div class="mb-8">
            <div class="relative">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="w-24 h-24 bg-gradient-to-r from-gabon-green to-gabon-blue rounded-full flex items-center justify-center animate-bounce">
                        <i class="fas fa-home text-white text-3xl"></i>
                    </div>
                </div>
                
                <!-- Éléments décoratifs flottants -->
                <div class="absolute top-10 left-10 w-8 h-8 bg-gabon-yellow rounded-full animate-pulse opacity-60"></div>
                <div class="absolute top-20 right-16 w-6 h-6 bg-gabon-blue rounded-full animate-pulse opacity-40 animation-delay-1000"></div>
                <div class="absolute bottom-16 left-20 w-10 h-10 bg-gabon-green rounded-full animate-pulse opacity-50 animation-delay-2000"></div>
                <div class="absolute bottom-10 right-10 w-4 h-4 bg-gabon-yellow rounded-full animate-pulse opacity-70 animation-delay-1500"></div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <form action="{{ route('search.index') }}" method="GET" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <select name="type" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-gabon-green focus:border-transparent">
                    ...
                    <select name="city" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-gabon-green focus:border-transparent">
                ...
                <button type="submit" 
                        class="w-full bg-gradient-to-r from-gabon-green to-gabon-blue text-white font-bold py-3 px-6 rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-200">
                    <i class="fas fa-search mr-2"></i>
                    Rechercher
                </button>
            </form>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('properties.index') }}" class="group">
                    <div class="bg-white rounded-xl shadow-md overflow-hidden group-hover:shadow-xl transform group-hover:scale-105 transition-all duration-200">
                        <div class="h-48 bg-gradient-to-br from-gabon-green to-gabon-blue flex items-center justify-center">
                ...
                <a href="{{ route('properties.index') }}" class="group">
                    <div class="bg-white rounded-xl shadow-md overflow-hidden group-hover:shadow-xl transform group-hover:scale-105 transition-all duration-200">
                        <div class="h-48 bg-gradient-to-br from-gabon-blue to-gabon-yellow flex items-center justify-center">
                ...
                <a href="{{ route('properties.index') }}" class="group">
                    <div class="bg-white rounded-xl shadow-md overflow-hidden group-hover:shadow-xl transform group-hover:scale-105 transition-all duration-200">
                        <div class="h-48 bg-gradient-to-br from-gabon-yellow to-gabon-green flex items-center justify-center">
